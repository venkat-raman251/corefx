...
namespace System.Security.AccessControl
{
    ...
    public abstract class GenericSecurityDescriptor
    {
        ...
        public string GetSddlForm(AccessControlSections includeSections)
        {
            ...
            if (error == Interop.ERROR_INVALID_PARAMETER ||
                error == Interop.ERROR_UNKNOWN_REVISION)
            {
                //
            ...
            else if (error != Interop.ERROR_SUCCESS)
            {
        ...
        private static byte[] BinaryFormFromSddlForm(string sddlForm)
        {
            ...
            try
            {
                        ...
                        ref byteArraySize))
                {
                    ...
                    if (error == Interop.ERROR_INVALID_PARAMETER ||
                        error == Interop.ERROR_INVALID_ACL ||
                        error == Interop.ERROR_INVALID_SECURITY_DESCR ||
                        error == Interop.ERROR_UNKNOWN_REVISION)
                    {
                        throw new ArgumentException(
                    ...
                    else if (error == Interop.ERROR_NOT_ENOUGH_MEMORY)
                    {
                        throw new OutOfMemoryException();
                    }
                    else if (error == Interop.ERROR_INVALID_SID)
                    {
                        throw new ArgumentException(
