            ...
            try
            {
                ...
                if (error != Interop.ERROR_SUCCESS)
                {
                    ...
                    if (exception == null)
                    {
                        ...
                        else if (error == Interop.ERROR_INVALID_HANDLE)
                        {
